...
Write a second loop that prints each number and its square on a new line, like this:
...
```python
for nums in [12, 10, 32, 3, 66, 17, 42, 99, 20]:
    print(nums)

for nums in [12, 10, 32, 3, 66, 17, 42, 99, 20]:
    print("The square of ", nums, "is ", nums **2)
```
